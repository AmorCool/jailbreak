...
// previously defined HOOK_DYLIB_PATH as a macro (fixed /usr/lib/systemhook.dylib).
// Undef it here so the roothide variable semantics are kept (randomized name
// via jbrand, filled below in roothide_init).
